      ...
      <div className="bg-white rounded-xl max-w-md w-full p-6 shadow-2xl border border-gray-200">
        ...
        <div className="space-y-6">
          <div className="bg-blue-50 p-4 rounded-lg border border-blue-200">
            ...
            <Typography
              variant="list"
              className="list-decimal list-inside text-sm space-y-2 text-blue-800"
            >
          ...
          <div className="bg-green-50 p-4 rounded-lg border border-green-200">
            <Typography
              variant="h3"
              className="font-semibold text-green-900 mb-3 flex items-center"
            >
            ...
            <Typography
              variant="list"
              className="list-decimal list-inside text-sm space-y-2 text-green-800"
            >
          ...
          <div className="bg-orange-50 p-4 rounded-lg border border-orange-200">
            ...
            <Typography
              variant="list"
              className="list-decimal list-inside text-sm space-y-2 text-orange-800"
            >
              <Typography variant="listItem">Click the menu (☰) in the address bar</Typography>
