export const EXPENSE_CATEGORIES = [
  ...
  },
  {
    ...
    description:
      "Продукти харчування, засоби гігієни, побутова хімія, посуд, дрібна техніка",
    icon: "🛒",
    subcategories: [
      "Продукти харчування",
      "Засоби гігієни",
  ...
  },
  {
    name: "Покупки",
    description:
      "Одяг, взуття, аксесуари, електроніка, меблі та побутова техніка",
    icon: "🛍",
    subcategories: [
      "Одяг, взуття",
      "Аксесуари",
  ...
  },
  {
    name: "Спорт і краса",
    description:
      "Фітнес / спортзал, масаж, спа, косметика, догляд, перукар, салон краси",
    icon: "🧘‍♂️",
    subcategories: [
      "Фітнес / спортзал",
      "Масаж, спа",
  ...
  },
  {
    ...
    description:
      "Кіно, театри, концерти, подорожі, туризм, хобі, ігри, подарунки",
    icon: "🎉",
    subcategories: [
  ...
  },
  {
    ...
    description:
      "Банківські комісії, кредити, відсотки, перекази / грошові збори, інвестиції",
    icon: "🧾",
    subcategories: [
      "Банківські комісії",
      "Кредити, відсотки",
