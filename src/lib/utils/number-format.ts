 ...
 */
export function formatCurrency(value: number | string | null | undefined, options: Omit<NumberFormatOptions, 'showCurrency'> = {}): string {
 ...
 */
export function formatPercentage(value: number | string | null | undefined, options: Omit<NumberFormatOptions, 'showCurrency' | 'currencySymbol'> = {}): string {
  const numValue = typeof value === 'string' ? parseFloat(value) : value;
  ...
  const formatted = formatNumber(percentageValue, { ...options, showCurrency: false });
